...
export async function POST(req: NextRequest): Promise<NextResponse<EnsureConversationResponse>> {
  try {
    ...
    // Generate generic placeholder title
    // Smart title will be generated by history route on first load
    const quickTitle = 'New Chat';

    // Create conversation with generic placeholder
    // Smart title will be generated by history route on first load (isDefaultLike check)
