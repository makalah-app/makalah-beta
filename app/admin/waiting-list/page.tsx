...
function WaitingListTable() {
  ...
  const [statusFilter, setStatusFilter] = useState<'all' | 'pending' | 'invited' | 'converted'>('all');
  ...
  return (
    ...
    <Card className="mb-6">
      <CardHeader>
        ...
        <CardDescription>Pencarian cepat berdasarkan email waiting list.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
          <div className="space-y-2">
            <Label htmlFor="search-waitlist" className="text-sm">Pencarian</Label>
          ...
          <div className="space-y-2">
            ...
            <Select value={statusFilter} onValueChange={(val: 'all' | 'pending' | 'invited' | 'converted') => { setStatusFilter(val); setPage(1); }}>
    ...
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">Daftar Waiting List</CardTitle>
        <CardDescription>
          Menampilkan {firstItem}-{lastItem} dari {total} email.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
      ...
      {loading ? (
        ...
        <div className="flex items-start gap-3 rounded border border-destructive bg-destructive/10 p-4 text-sm">
          <span className="font-medium text-destructive">Gagal memuat data</span>
