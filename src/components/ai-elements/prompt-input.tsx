...
export const PromptInputActionMenuContent = ({
  ...
  <DropdownMenuContent
    align="start"
    className={cn(
      "rounded-[3px] border border-border bg-popover shadow-lg animate-in fade-in-0 zoom-in-95 slide-in-from-top-2",
      className
    )}
    {...props}
  />
...
export const PromptInputActionMenuItem = ({
  ...
  <DropdownMenuItem
    className={cn(
      "rounded-[3px] hover:bg-accent hover:text-accent-foreground transition-colors duration-200 cursor-pointer",
      className
    )}
    {...props}
  />
...
export const PromptInputModelSelectTrigger = ({
  ...
  <SelectTrigger
    className={cn(
      "border-none bg-transparent font-medium text-muted-foreground shadow-none transition-all duration-200 rounded-[3px]",
      'hover:bg-accent hover:text-foreground hover:scale-105 [&[aria-expanded="true"]]:bg-accent [&[aria-expanded="true"]]:text-foreground',
      className
    )}
    {...props}
  />
